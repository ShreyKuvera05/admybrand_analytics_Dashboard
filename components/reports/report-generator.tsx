...
0 -40 Td
(Company: analytics Analytics) Tj
0 -60 Td
/F1 14 Tf
...
0 -40 Td
(Report generated by analytics Analytics Dashboard) Tj
0 -20 Td
...
%%EOF`;
    ...
    a.href = url;
    a.download = `${reportName.replace(
      /\s+/g,
      "%20"
    )}%20-%20${currentDate.replace(/\//g, "%2F")}.pdf`;
  ...
  const generateCSV = (type: string, data: any) => {
    ...
    csvContent += `"Company","analytics Analytics"\n\n`;
    ...
    const a = document.createElement("a");
    a.href = url;
    a.download = `${reportName.replace(/\s+/g, "_")}_${currentDate.replace(
      /\//g,
      "_"
    )}.csv`;
    document.body.appendChild(a);
  ...
  const reportTypes = [
    {
      ...
      description:
        "Comprehensive analytics on website performance, traffic, and conversions",
      icon: BarChart3,
    ...
    },
    {
      ...
      description:
        "Detailed insights into your audience demographics and behavior",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Analysis of marketing campaigns performance and ROI metrics",
      icon: Target,
        ...
        >
          <CardHeader>
            <CardTitle className="text-gray-900 dark:text-white flex items-center">
              <div
                className={`p-2 rounded-lg bg-gradient-to-r ${report.color} mr-3`}
              >
